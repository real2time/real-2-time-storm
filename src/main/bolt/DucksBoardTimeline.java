...
public class DucksBoardTimeline extends BaseRichBolt {
    ...
    public DucksBoardTimeline(String id, String key){
    	this.idString = id;
    	this.keyString = key;
    }
  ...
  public void execute(Tuple tuple) {
	  ...
	  Aylien2 aylien = new Aylien2("306a2209","bdf8cda4529818b64341c56daddcef9f");
	  
	  String txt = "{\"timestamp\": "+calendar.getTime().getTime()+", \"value\": {\"title\": \""+aylien.getSentiment(tuple.getStringByField(this.fields[0])).getPolarity()+"\",\"image\": \"\",\"content\": \""+tuple.getStringByField("text")+"\"}}";
	  
	 
	  dao.push(this.idString,txt);
